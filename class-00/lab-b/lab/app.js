...
// "this" refers to the new instance of a Student and is using the parameters from prior code lines.
// 2. What is "this" when joe.scopeArrow() is invoked?
//"this" returns an instance of a window array.
// 3. Explain why "this" is different when an arrow function is used.
//I believe "this" is different because when in an arrow function "this" binds to the window object because it is out of scope.
